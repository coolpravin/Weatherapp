...
public class GPSTracker extends Service implements LocationListener {
    ...
    public void showSettingsAlert(){
    	...
    	Button gpsSettingBtn = (Button) gpsDialog.findViewById(R.id.btn_setting_gps_dialog);
    	Button gpsCancelBtn = (Button) gpsDialog.findViewById(R.id.btn_cancel_gps_dialog);
